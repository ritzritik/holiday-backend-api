<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #006DCF;">
    ...
    <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                {{-- @foreach ($newSubscribers as $subscriber)
                    <a class="dropdown-item d-flex align-items-center"
                        href="{{ route('admin.subscribers', $subscriber->id) }}">
                        <div class="mr-3">
                        ...
                        <div>
                            ...
                            <span class="font-weight-bold">New subscriber: {{ $subscriber->email }}</span>
                        </div>
                    </a>
                @endforeach --}}
                <a class="dropdown-item text-center small text-gray-500" href="{{ route('admin.subscribers') }}">Show All
                    Alerts</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                @else
                    <span class="mr-2 d-none d-lg-inline text-white small">Guest</span>
                @endif
