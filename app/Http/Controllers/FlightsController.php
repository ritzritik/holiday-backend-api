...
class FlightsController extends Controller
{
    ...
    public function flightSearch(Request $request)
    {
        ...
        $children = (int) preg_replace('/\D/', '', $request->input('children', '0'));
        ...
        foreach ($flightsArray as &$flight) {
            $pricePerPerson = isset($flight['fltSellpricepp']) ? (float) $flight['fltSellpricepp'] : 0;
        ...
        return response()->json([
            'message' => 'success',
            'data' => [
                'flights' => array_values($flightsArray),
                'queryParams' => request()->query() ?: null,
            ],
            'statusCode' => 200
        ]);
    ...
    public function flight_checkout(Request $request)
    {
